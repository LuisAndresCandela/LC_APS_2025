...
plt.subplot(2, 1, 2)
plt.plot(t_ecg, ecg_one_lead, label='ECG original', color='gray', alpha=0.6)
plt.plot(t_ecg, baseline_spline, label='Baseline - Spline cúbico', linewidth=2, linestyle='--')
...
plt.subplot(2, 1, 2)
plt.plot(t_zoom, ecg_zoom, label='ECG original', color='gray', alpha=0.6)
plt.plot(t_zoom, baseline_spline_zoom, label='Baseline - Spline cúbico', linewidth=2, linestyle='--')
